...
class EntrepriseResourceIT {
    ...
    public static Entreprise createEntity(EntityManager em) {
        Entreprise entreprise = new Entreprise().entreprise(DEFAULT_ENTREPRISE);
        return entreprise;
    }
    ...
    public static Entreprise createUpdatedEntity(EntityManager em) {
        Entreprise entreprise = new Entreprise().entreprise(UPDATED_ENTREPRISE);
        return entreprise;
    }
    ...
    void createEntreprise() throws Exception {
        ...
        assertThat(testEntreprise.getEntreprise()).isEqualTo(DEFAULT_ENTREPRISE);
    }
    ...
    void putNewEntreprise() throws Exception {
        ...
        updatedEntreprise.entreprise(UPDATED_ENTREPRISE);
        ...
        Entreprise testEntreprise = entrepriseList.get(entrepriseList.size() - 1);
        assertThat(testEntreprise.getEntreprise()).isEqualTo(UPDATED_ENTREPRISE);
    }
    ...
    void partialUpdateEntrepriseWithPatch() throws Exception {
        ...
        partialUpdatedEntreprise.entreprise(UPDATED_ENTREPRISE);
