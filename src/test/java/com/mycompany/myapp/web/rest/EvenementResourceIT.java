...
class EvenementResourceIT {
    ...
    public static Evenement createEntity(EntityManager em) {
        Evenement evenement = new Evenement().evenement(DEFAULT_EVENEMENT);
        return evenement;
    }
    ...
    public static Evenement createUpdatedEntity(EntityManager em) {
        Evenement evenement = new Evenement().evenement(UPDATED_EVENEMENT);
        return evenement;
    }
    ...
    void createEvenement() throws Exception {
        ...
        assertThat(testEvenement.getEvenement()).isEqualTo(DEFAULT_EVENEMENT);
    }
    ...
    void putNewEvenement() throws Exception {
        ...
        updatedEvenement.evenement(UPDATED_EVENEMENT);
        ...
        Evenement testEvenement = evenementList.get(evenementList.size() - 1);
        assertThat(testEvenement.getEvenement()).isEqualTo(UPDATED_EVENEMENT);
    }
    ...
    void fullUpdateEvenementWithPatch() throws Exception {
        ...
        partialUpdatedEvenement.evenement(UPDATED_EVENEMENT);
